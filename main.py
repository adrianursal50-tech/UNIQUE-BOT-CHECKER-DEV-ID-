#!/usr/bin/env python3
# ===================================================================
# DEV ID Checker — Telegram Bot v3.4  ◈  SHIN CYBER EDITION
# -------------------------------------------------------------------
...
class GameConnection(BaseConnection):
    ...
    @staticmethod
    def _coerce_zone(z):
        """zone_id can arrive as int, list, SdpStruct, or nested dict."""
    ...
    def _parse_hostport(raw):
        """Host:port might be str, bytes, or a nested dict/struct."""
    ...
    def get_game_server(self):
        """Ask PID 5 for the game server. Reads MULTIPLE packets, retries 3x."""
...
# ════════════════════════════════════════════════════════════════
# DETAIL CHECK (single device) — stage-specific reason
# ════════════════════════════════════════════════════════════════
