...
BAN_WAIT        = float(os.environ.get("MLBB_BAN_WAIT",       "20.0"))   # overall budget for ban response
BAN_READ_CHUNK  = float(os.environ.get("MLBB_BAN_READ_TIMEOUT", "3.0"))  # per-read timeout during ban check
